...
sed -i "s|ckan.plugins .*|ckan.plugins = stats text_view image_view recline_view recline_grid_view recline_graph_view recline_map_view datastore datapusher disablepwreset pdf_view privatedatasets resource_proxy videoviewer papaya vtkjs elaine_theme ldap dcat dcat_json_interface structured_data|g" /etc/ckan/production.ini
